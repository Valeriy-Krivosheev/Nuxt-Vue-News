<template>
  <header
    class="flex items-center justify-center min-h-6 px-2 py-2 fixed z-10 left-0 right-0 shadow-boxShadow bg-white rounded-b dark:bg-gray-700"
  >
    <nuxt-link
      to="/"
      class="text-2xl font-medium text-gray-900 flex-1 flex justify-center"
    >
      <img class="w-[200px]" src="/public/images/logo.jpg" alt="Logo" />
    </nuxt-link>
    <button
      id="theme-toggle"
      type="button"
