<template>
  ...
  <aside
    id="default-sidebar"
    class="fixed left-0 top-0 z-[31] w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidebar"
  >
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <div class="flex">
        <nuxt-link to="/" class="text-2xl font-medium text-gray-900">
          <img class="w-[200px]" src="/public/images/logo.png" alt="Logo" />
        </nuxt-link>
        <button
          id="theme-toggle"
          type="button"
          class="rounded-lg p-2.5 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700"
          @click="toggleTheme"
        >
          <svg
      ...
      <ul class="space-y-2 font-medium pt-6">
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Science</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Sports</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Technology</span>
          </a>
        </li>
      </ul>
    </div>
...
const initializeTheme = () => {
  ...
  const mySystemPreferenceIs = window.matchMedia("(prefers-color-scheme: dark)")
    .matches
    ? "dark"
    : "light";
